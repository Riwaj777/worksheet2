...
Original file is located at
    https://colab.research.google.com/drive/1NRgMr0BU4UmfJ7O6fN70FgLcMphbz3_V
"""

#3.1
#Q.1
import pandas as pd
reader = pd.read_csv("/content/drive/MyDrive/Riwaz/bank .csv")
...
#Q.1
import pandas as pd
reader= pd.read_csv("/content/drive/MyDrive/Riwaz/medical_students_dataset.csv")
data_frame = pd.DataFrame(reader)
print(data_frame)
...
#Problem1
import pandas as pd
reader = pd.read_csv("/content/drive/MyDrive/Riwaz/Titanic-Dataset.csv")
data_frame = pd.DataFrame(reader)
...
survival_rates.plot(kind='bar', color=['green', 'blue'], alpha=0.7)
...
survival_rates.plot(kind='bar', figsize=(8, 6), color=['orange', 'black'], alpha=0.7)
